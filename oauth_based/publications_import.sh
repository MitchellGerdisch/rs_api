...
if [ $# -ne 3 ] 
then
	echo "USAGE: $0 API_ENDPOINT REFRESH_TOKEN PUBLICATION_ID"  
	...
	echo "Where PUBLICATION ID is the ID of the item you want to import."
	echo "    NOTE: You can find the ID by using the publications_find.sh script."
	exit 1
fi
...
curl --include \
     ...
     -X POST "${base_uri}/api/publications/${publication_id}/import"
