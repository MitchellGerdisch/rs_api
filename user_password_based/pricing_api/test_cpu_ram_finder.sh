...
-d filter='{"public_cloud_vendor_name":["Google"],"cpu_count":[2,4],"memory":["3.6","3.75","4"],"resource_type":["instance"],"purchase_option_type":["on_demand_instance"],"platform":["Linux/UNIX"],"platform_version":[null]}' 
