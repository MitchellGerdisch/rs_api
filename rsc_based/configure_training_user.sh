...
do
	...
	echo "LastName,FirstName,CompanyName,EmailAddress,PhoneNumber,Password"
	echo ""
...
cat ${filepath} |
sed 's/,/ /g' |
while read lastName firstName companyName emailAddress phoneNumber password
do
	...
	for role in observer actor server_login server_superuser security_manager library billing designer publisher admin
	do
